...
TweenMax.set($(".contin"), {x:1000,y:500,color:"rgba(255,255,255,1)"});
...
TweenMax.to($(".desinks"), 1, {delay:1,x:0,ease: Back.easeOut.config(0.7)});
TweenMax.to($(".petit"), 1, {delay:1.5,x:0,ease: Back.easeOut.config(0.7)});
TweenMax.to($(".contin"), 5, {color:"rgba(3,255,129,1)",yoyo:true, repeat:-1});
TweenMax.to($(".contin"), 1, {delay:2,x:0,ease: Back.easeOut.config(0.7)});
